	...
	parachute_dore_demoStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'CajaIMGBillanOral', type: 'widget', widget: 'blink_box', attributes: { 'class': 'bck-box-18' } },
				{ name: 'CajaBilanEcrit', type: 'widget', widget: 'blink_box', attributes: { 'class': 'bck-box-16' } },
				{ name: 'CajaIMGBilanEcrit', type: 'widget', widget: 'blink_box', attributes: { 'class': 'bck-box-19' } },
